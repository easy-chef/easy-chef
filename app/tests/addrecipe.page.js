...
class AddRecipePage {
  ...
  async addRecipe(testController, recipeName, recipeAuthor, recipeEmail, description, image, total, rating, servings, ingredients, tools, steps) {
    ...
    await testController.typeText('#add-recipe-email', recipeEmail);
    ...
    await testController.click('#uniforms-0001-000g');
